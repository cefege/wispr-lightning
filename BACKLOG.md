...
- **Status:** done (commit 5ce7784) — `hotkeyTapToToggle` setting, lock-on-quick-release path in `onHotkeyRelease`, Shortcuts panel toggle row. PTT (hold) behavior unchanged when the setting is off.
